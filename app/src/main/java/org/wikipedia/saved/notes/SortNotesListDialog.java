...
public class SortNotesListDialog extends ExtendedBottomSheetDialogFragment {
    public interface Callback {
        void onSortOptionClick(int position);
    }
    private static final String SORT_OPTION = "sortOption";
    private NotesListSortAdapter adapter;
    private List<String> sortOptions = new ArrayList<>();
    private int chosenSortOption;

    public static SortNotesListDialog newInstance(int sortOption) {
        SortNotesListDialog dialog = new SortNotesListDialog();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sortOptions = Arrays.asList(getResources().getStringArray(R.array.sort_options_notes));
        adapter = new NotesListSortAdapter();
    ...
    private final class NotesListSortAdapter extends RecyclerView.Adapter<SortNotesListDialog.SortItemHolder> {
        @Override
